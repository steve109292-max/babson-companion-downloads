...
main() {
  ...
  case "$(/usr/bin/uname -m)" in
    arm64) arch=arm64; expected=2284145c36d5201786c2ced335de308a50e424ed7fde595be52d2ad0cfbbbaf9 ;;
    x86_64) arch=x64; expected=4c5cf1751ffbaf7d313431c32159e9b91aa2ee5828b2b36d2cd76d600681de42 ;;
  ...
  /usr/bin/curl --proto '=https' --tlsv1.2 --fail --location --retry 2 --connect-timeout 20 --max-time 600 --progress-bar "https://github.com/steve109292-max/babson-companion-downloads/releases/download/v0.1.0-prep.12/babson-companion-0.1.0-prep.12-macos-$arch.command" --output "$file"
