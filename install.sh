...
main() {
  ...
  case "$(/usr/bin/uname -m)" in
    arm64) arch=arm64; expected=234e664bb8ee8771800bd7061555fd591f8751ab8aa54693eff41f1d18190f8c ;;
    x86_64) arch=x64; expected=f376ddacc0ac8f6787d30e07ea93aa47dea353498a3fe3a064699188d7289957 ;;
  ...
  /usr/bin/curl --proto '=https' --tlsv1.2 --fail --location --retry 2 --connect-timeout 20 --max-time 600 --progress-bar "https://github.com/steve109292-max/babson-companion-downloads/releases/download/v0.1.0-prep.14/babson-companion-0.1.0-prep.14-macos-$arch.command" --output "$file"
